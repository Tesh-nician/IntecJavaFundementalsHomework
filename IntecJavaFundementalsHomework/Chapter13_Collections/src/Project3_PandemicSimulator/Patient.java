...
public class Patient {
    ...
    public Patient(String nationalRegistry, String fullName, int age, int temperature, boolean unknownVirus, boolean insured) {
    ...
    public String toString() {
        return  "nationalRegistry='" + nationalRegistry + '\'' +
                ", fullName='" + fullName + '\'' +
                ", age=" + age +
